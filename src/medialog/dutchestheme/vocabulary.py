...
from medialog.themefragments.interfaces import FRAGMENTS_DIRECTORY
from medialog.themefragments.traversal import ThemeFragment
from medialog.themefragments.utils import cache
from medialog.themefragments.utils import getFragmentsSettings
...
_ = MessageFactory('medialog.themefragments')

logger = logging.getLogger('medialog.themefragments')
